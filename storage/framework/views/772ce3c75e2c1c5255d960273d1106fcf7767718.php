		...
		<div id="main" class="col-md-12 col-lg-8 offset-lg-2">
			...
			<div id="books">
				<?php if(count($books) == 0): ?>
					<h4 class="text-center">Aucun livre correspondant à votre recherche n'est disponible.</h4>
				<?php endif; ?>
			...
			<div id="nav">
				<?php if($page > 0): ?>
					<a href='/search/<?php echo e($search); ?>/<?php echo e($previous); ?>' class="simple navBtn leftBtn"><i class="fa fa-chevron-left"></i>PRECEDENT</a>
				<?php endif; ?>

				<?php if($next != $page): ?>
					<a href='/search/<?php echo e($search); ?>/<?php echo e($next); ?>' class="simple navBtn rightBtn">SUIVANT<i class="fa fa-chevron-right"></i></a>
				<?php endif; ?>
			</div>
		</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/yohann/code/library/resources/views/search.blade.php ENDPATH**/ ?>