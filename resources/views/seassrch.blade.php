...
@section('content')
		...
		<div id="main" class="col-md-12 col-lg-8 offset-lg-2">
			...
			<div id="nav">
				@if ($page > 0)
					<a href='/search/{{ $search }}/{{ $previous }}' class="simple navBtn leftBtn"><i class="fa fa-chevron-left"></i>PRECEDENT</a>
				@endif

				@if ($next != $page)
					<a href='/search/{{ $search }}/{{ $next }}' class="simple navBtn rightBtn">SUIVANT<i class="fa fa-chevron-right"></i></a>
				@endif
			</div>
		</div>
