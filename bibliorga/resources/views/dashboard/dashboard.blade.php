...
@section('content')
    ...
    <div class="row tile_count">
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <span class="count_top"><i class="fa fa-user"></i> {{__("Nombre total d'utilisateurs")}}</span>
            <div class="count">{{ $users->count() }}</div>
            <span class="count_bottom"><i class="green">4% </i> From last Week</span>
        </div>
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <span class="count_top"><i class="fa fa-clock-o"></i> {{ __("Nombre total d'emprunt") }}</span>
            <div class="count">{{ $borrows->count() }}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>{{ $borrows->where('isBorrow', false)->count() }} </i> Livres pas encore rendu</span>
        </div>
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <span class="count_top"><i class="fa fa-user"></i> {{ __("Nombre total d'hommes") }}</span>
            <div class="count green">{{$users->where('sex', \App\Enums\SexEnum::MALE)->count()}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>34% </i> From last Week</span>
        </div>
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <span class="count_top"><i class="fa fa-user"></i> {{ __("Nombre total de femmes") }}</span>
            <div class="count">{{ $users->where('sex', \App\Enums\SexEnum::FEMALE)->count() }}</div>
            <span class="count_bottom"><i class="red"><i class="fa fa-sort-desc"></i>12% </i> From last Week</span>
        </div>
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <span class="count_top"><i class="fa fa-user"></i> {{__("Nombre total de livres")}}</span>
            <div class="count">{{$books->count()}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>34% </i> From last Week</span>
        </div>
        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <span class="count_top"><i class="fa fa-user"></i> {{ __("Nombre total d'auteurs") }}</span>
            <div class="count">{{ $authors->count() }}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>34% </i> From last Week</span>
        </div>
    </div>
    <!-- /top tiles -->
